...
using Plesanter.CLB.Client.Shared.AITextAnalyzer;
using Plesanter.CLB.Client.Shared.ScriptObjects;
using Plesanter.CLB.Designer.Lib;
using Plesanter.CLB.Designer.Lib.AI;
using Plesanter.CLB.Designer.Lib.DbTableToModule;
using Plesanter.CLB.Designer.Lib.ExcelToModule;
using Plesanter.CLB.Designer.Lib.ModuleToClass;
using Plesanter.CLB.Designer.Lib.SeleniumPageObject;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Win32;

namespace Plesanter.CLB.Designer
{
    public partial class App : DesignerApp
    {
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            ScriptRuntimeTypeManager.AddType(typeof(Plesanter.CLB.Client.Shared.ScriptObjects.Excel));
            ...
            BlazorRuntime.InstallBundleCss("Plesanter.CLB.Client.Shared");

            IconCandidate.Icons.AddRange(Plesanter.CLB.Designer.Properties.Resources.bootstrap_icons
            ...
            MainWindow.Title = "Plesanter.CLB";
        ...
        {
            using Stream stream = new MemoryStream(Plesanter.CLB.Designer.Properties.Resources.EmptyTemplate);
            ...
            if (!File.Exists(dbPath))
            {
                ...
                File.WriteAllBytes(dbPath, Plesanter.CLB.Designer.Properties.Resources.sqlite_sample);
            }
        }

        static void CreateGettingStandard(string path)
        {
            using Stream stream = new MemoryStream(Plesanter.CLB.Designer.Properties.Resources.GettingStartedTemplate);
            ZipFile.ExtractToDirectory(stream, path);
